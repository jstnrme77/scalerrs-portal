...
function formatBacklinkItem(record: any): ApprovalItem {
  ...
  return {
    ...
    upliftPotential: fields["Keyword Uplift Potential"] || "0",
    currentPosition: fields["Current Position"] || "0",
    keywordScore: fields["Keyword Score"] || "0",
    pageType: fields["Target Page Type"] || "Not Specified",
