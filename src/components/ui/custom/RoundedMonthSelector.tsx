...
export default function RoundedMonthSelector({ selectedMonth, onChange }: RoundedMonthSelectorProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div
        className="flex items-center justify-between w-52 px-4 py-2 font-medium bg-white border border-gray-200 hover:bg-gray-50 cursor-pointer rounded-full"
      ...
      {isOpen && (
        <div
          className="absolute right-0 top-12 w-64 bg-white shadow-lg z-20 border border-gray-200 rounded-2xl overflow-hidden"
        >
          <div className="py-1 max-h-80 overflow-y-auto">
            {/* Next Year Section (up to April only) */}
            <div className="px-4 py-2 font-bold text-primary bg-primary/5 border-b border-gray-200" style={{ fontSize: '16px' }}>
              {nextYear} (Jan-Apr)
            </div>
            ...
            <div className="px-4 py-2 font-bold text-primary bg-primary/5 border-b border-t border-gray-200" style={{ fontSize: '16px' }}>
              {currentYear}
            </div>
