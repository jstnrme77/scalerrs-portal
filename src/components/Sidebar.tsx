...
const navItems = [
  { name: 'Deliverables', href: '/deliverables', icon: DashboardIcon },
  { name: 'KPI Dashboard', href: '/kpi-dashboard', icon: KpiIcon },
  { name: 'Reports', href: '/reports', icon: ReportIcon },
  { name: 'Approvals', href: '/approvals', icon: ApprovalIcon },
  { name: 'Task Boards', href: '/task-boards', icon: TaskIcon },
  { name: 'Content Workflow', href: '/content-workflow', icon: ContentIcon },
