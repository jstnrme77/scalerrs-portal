...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center justify-center w-10 h-10 rounded-lg bg-lightGray dark:bg-darkGray border border-lightGray dark:border-gray-700 transition-colors hover:bg-gray-200 dark:hover:bg-gray-800"
