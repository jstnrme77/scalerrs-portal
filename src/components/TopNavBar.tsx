...
export default function TopNavBar({
  ...
  return (
    <div className={`fixed top-0 ${sidebarExpanded ? 'left-64' : 'left-20'} right-0 h-16 bg-white dark:bg-dark border-b border-gray-200 dark:border-gray-700 z-50 flex justify-between items-center px-6 transition-all duration-300 rounded-none`} style={{ zIndex: 9999 }}>
