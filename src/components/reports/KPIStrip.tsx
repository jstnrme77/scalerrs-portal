...
export default function KPIStrip({
  ...
  return (
    <div className="space-y-2">
      ...
      {/* Disclaimer */}
      <div className="rounded-lg p-3 text-xs font-normal" style={infoStyle}>
        <span className="font-medium">Note:</span> ROI and CPC values are provisional and will auto-update after month&nbsp;2.
      </div>
    </div>
  );
} 